...
app.use(cors("https://mood-fgphlrl63-namrata7.vercel.app")); //allows frontend to connect
...
const io = new Server(server, //creates realtime socket server
  {
    cors : {origin : "https://mood-fgphlrl63-namrata7.vercel.app"}, //allow fronted to connet
    methods: ["GET", "POST"],
  });
